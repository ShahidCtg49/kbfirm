    ...
    @endif
        ...
        <div class="widget-box">
			<div class="widget-header widget-header-small">
				<h5 class="widget-title lighter">Tax Add Form</h5>
			</div>
			<div class="widget-body">
				<div class="widget-main">
					<form action="{{route('tax.store')}}" method="post" class="form-search" enctype="multipart/form-data">
					@csrf
						<div class="row">
							<div class="col-12 col-sm-6">
								<div class="form-group @if($errors->has('tax_name')) has-error @endif">
									...
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="tax_name" value="{{old('tax_name')}}">
							...
							<div class="col-12 col-sm-6">
								<div class="form-group @if($errors->has('tax_percentage')) has-error @endif">
									<label>Percentage</label>
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="tax_percentage" value="{{old('tax_percentage')}}">
