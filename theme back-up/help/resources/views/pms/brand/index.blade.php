...
<div class="row">
	<div class="col-6">
        ...
        <div class="widget-box">
			<div class="widget-header widget-header-small">
				<h5 class="widget-title lighter">Brand Add Form</h5>
			</div>
			<div class="widget-body">
				<div class="widget-main">
					<form action="{{route('pmsbrand.store')}}" method="post" class="form-search" enctype="multipart/form-data">
					@csrf
						<div class="row">
							<div class="col-12 col-sm-6">
								<div class="form-group @if($errors->has('brand_name')) has-error @endif">
									...
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="brand_name" value="{{old('brand_name')}}">
    ...
    <div class="col-6">
        ...
        <table class="table">
            ...
            <tbody>
                @if($brand)
                    @foreach($brand as $i=>$u)
                        <tr>
                            <td>{{++$i}}</td>
                            <td>{{$u->brand_name}}</td>
                            <td>
                                <a href="{{route('pmsbrand.edit',$u->id)}}" ><i class="fa fa-edit"></i></a>
