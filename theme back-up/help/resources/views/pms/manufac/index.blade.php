...
<div class="row">
	<div class="col-6">
        ...
        <div class="widget-box">
			<div class="widget-header widget-header-small">
				<h5 class="widget-title lighter">Manufacturar Add Form</h5>
			</div>
			<div class="widget-body">
				<div class="widget-main">
					<form action="{{route('pmsmanufac.store')}}" method="post" class="form-search" enctype="multipart/form-data">
					@csrf
						<div class="row">
							<div class="col-12 col-sm-6">
								<div class="form-group @if($errors->has('manufac_name')) has-error @endif">
									<label>Manufacturar Name</label>
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="manufac_name" value="{{old('manufac_name')}}">
										@if($errors->has('manufac_name')) 
											<i class="ace-icon fa fa-times-circle"></i>
										@endif
									</span>
									@if($errors->has('manufac_name')) 
										<div class="help-block col-sm-reset">
									{{ $errors->first('manufac_name') }}
										</div>
								@endif
								</div>
							</div>
    ...
    <div class="col-6">
        ...
        <table class="table">
            ...
            <tbody>
                @if($manufac)
                    @foreach($manufac as $i=>$u)
                        <tr>
                            <td>{{++$i}}</td>
                            <td>{{$u->manufac_name}}</td>
                            <td>
                                <a href="{{route('pmsmanufac.edit',$u->id)}}" ><i class="fa fa-edit"></i></a>
