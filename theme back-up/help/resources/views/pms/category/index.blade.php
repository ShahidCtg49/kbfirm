        ...
        <div class="widget-box">
			...
			<div class="widget-body">
				<div class="widget-main">
					<form action="{{route('pmscategory.store')}}" method="post" class="form-search" enctype="multipart/form-data">
					@csrf
						<div class="row">
							<div class="col-12 col-sm-6">
								<div class="form-group @if($errors->has('category_name')) has-error @endif">
									...
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="category_name" value="{{old('category_name')}}">
                ...
                @if($category)
                    @foreach($category as $i=>$u)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('pmscategory.edit',$u->id)}}" ><i class="fa fa-edit"></i></a>
