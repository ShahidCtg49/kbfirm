...
<div class="row">
    ...
    @endif
        ...
        <div class="widget-box">
			<div class="widget-header widget-header-small">
				<h5 class="widget-title lighter">Sub Category Add Form</h5>
			</div>
			<div class="widget-body">
				<div class="widget-main">
					<form action="{{route('pmssubcategory.store')}}" method="post" class="form-search" enctype="multipart/form-data">
					@csrf
						<div class="row">
						<div class="col-12 col-sm-6">
							<div class="form-group @if($errors->has('vcategory')) has-error @endif">
									...
									<span class="block input-icon input-icon-right">
										<select class="width-100" name="category_name">
							...
							<div class="col-12 col-sm-6">
								<div class="form-group @if($errors->has('subcategory_name')) has-error @endif">
									...
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="subcategory_name" value="{{old('head_name')}}">
    ...
    <div class="col-6">
        ...
        <table class="table">
            ...
            <tbody>
                @if($subcategory)
                    @foreach($subcategory as $i=>$u)
                        <tr>
                            <td>{{++$i}}</td>
                            <td>{{$u->subcategory_name}}</td>
                            <td>{{$u->cat_name->category_name}}</td>
                            <td>
                                <a href="{{route('pmssubcategory.edit',$u->id)}}" ><i class="fa fa-edit"></i></a>
