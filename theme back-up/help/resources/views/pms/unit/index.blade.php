	...
	<div class="col-6">
        ...
        <div class="widget-box">
			<div class="widget-header widget-header-small">
				<h5 class="widget-title lighter">Unit Add Form</h5>
			</div>
			<div class="widget-body">
				<div class="widget-main">
					<form action="{{route('pmsunit.store')}}" method="post" class="form-search" enctype="multipart/form-data">
					@csrf
						<div class="row">
							<div class="col-12 col-sm-6">
								<div class="form-group @if($errors->has('unit_name')) has-error @endif">
									...
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="unit_name" value="{{old('unit_name')}}">
                ...
                @if($unit)
                    @foreach($unit as $i=>$u)
                        <tr>
                            ...
                            <td>{{$u->unit_name}}</td>
                            <td>
                                <a href="{{route('pmsunit.edit',$u->id)}}" ><i class="fa fa-edit"></i></a>
