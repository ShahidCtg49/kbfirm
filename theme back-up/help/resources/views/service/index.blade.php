...
<div class="row">
	<div class="col-6">
        ...
        <div class="widget-box">
			<div class="widget-header widget-header-small">
				<h5 class="widget-title lighter">Service Add Form</h5>
			</div>
			<div class="widget-body">
				<div class="widget-main">
					<form action="{{route('service.store')}}" method="post" class="form-search" enctype="multipart/form-data">
					@csrf
						<div class="row">
							<div class="col-12 col-sm-6">
								<div class="form-group @if($errors->has('service_name')) has-error @endif">
									...
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="service_name" value="{{old('service_name')}}">
							...
							<div class="col-12 col-sm-6">
								<div class="form-group @if($errors->has('service_desc')) has-error @endif">
									...
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="service_desc" value="{{old('service_desc')}}">
    ...
    <div class="col-6">
        ...
        <table class="table">
            ...
            <tbody>
                @if($service)
                    @foreach($service as $i=>$u)
                        <tr>
                            <td>{{++$i}}</td>
                            <td>{{$u->service_name}}</td>
                            <td>{{$u->service_desc}}</td>
                          
                            
                            <td>
                                <a href="{{route('service.edit',$u->id)}}" ><i class="fa fa-edit"></i></a>
