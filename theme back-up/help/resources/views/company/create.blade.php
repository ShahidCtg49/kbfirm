    ...
    @endif
        ...
        <div class="widget-box">
			<div class="widget-header widget-header-small">
				<h5 class="widget-title lighter">Company Add Form</h5>
			</div>
			<div class="widget-body">
				<div class="widget-main">
					<form action="{{route('company.store')}}" method="post" class="form-search" enctype="multipart/form-data">
					@csrf
						<div class="row">
							<div class="col-12 col-sm-3">
								<div class="form-group @if($errors->has('company_name')) has-error @endif">
									...
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="company_name" value="{{old('company_name')}}">
							...
							<div class="col-12 col-sm-3">
								<div class="form-group @if($errors->has('title')) has-error @endif">
									...
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="title" value="{{old('title')}}">
										@if($errors->has('title')) 
											<i class="ace-icon fa fa-times-circle"></i>
										@endif
									</span>
							...
							<div class="col-12 col-sm-3">
								<div class="form-group @if($errors->has('reg_no')) has-error @endif">
									...
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="reg_no" value="{{old('reg_no')}}">
