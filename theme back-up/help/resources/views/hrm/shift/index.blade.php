...
<div class="row">
	<div class="col-6">
        ...
        <div class="widget-box">
			<div class="widget-header widget-header-small">
				<h5 class="widget-title lighter">Shift Add Form</h5>
			</div>
			<div class="widget-body">
				<div class="widget-main">
					<form action="{{route('shift.store')}}" method="post" class="form-search" enctype="multipart/form-data">
					@csrf
						<div class="row">
							<div class="col-12 col-sm-3">
								<div class="form-group @if($errors->has('shift_name')) has-error @endif">
									...
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="shift_name" value="{{old('shift_name')}}">
							...
							<div class="col-12 col-sm-3">
								<div class="form-group @if($errors->has('start_time')) has-error @endif">
									...
									<span class="block input-icon input-icon-right">
										<input type="time" class="width-100" name="start_time" value="{{old('start_time')}}">
							...
							<div class="col-12 col-sm-3">
								<div class="form-group @if($errors->has('end_time')) has-error @endif">
									...
									<span class="block input-icon input-icon-right">
										<input type="time" class="width-100" name="end_time" value="{{old('end_time')}}">
										@if($errors->has('category_name')) 
											<i class="ace-icon fa fa-times-circle"></i>
										@endif
									</span>
							...
							<div class="col-12 col-sm-3">
								<div class="form-group @if($errors->has('time_allow')) has-error @endif">
									<label>Allow L/E</label>
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="time_allow" value="{{old('time_allow')}}">
										@if($errors->has('time_allow')) 
											<i class="ace-icon fa fa-times-circle"></i>
										@endif
									</span>
									@if($errors->has('time_allow')) 
										<div class="help-block col-sm-reset">
									{{ $errors->first('time_allow') }}
										</div>
								@endif
								</div>
							</div>
						...
						<div class="col-12 col-sm-12">
								<div class="form-group @if($errors->has('shift_desc')) has-error @endif">
									<label>Shift Description</label>
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="shift_desc" value="{{old('shift_desc')}}">
										@if($errors->has('shift_desc')) 
											<i class="ace-icon fa fa-times-circle"></i>
										@endif
									</span>
									@if($errors->has('shift_desc')) 
										<div class="help-block col-sm-reset">
									{{ $errors->first('shift_desc') }}
										</div>
								@endif
								</div>
							</div>
    ...
    <div class="col-6">
        ...
        <table class="table">
            ...
            <tbody>
                @if($shift)
                    @foreach($shift as $i=>$u)
                        <tr>
                            <td>{{++$i}}</td>
                            <td>{{$u->shift_name}}</td>
                            <td>{{$u->start_time}}</td>
                            <td>{{$u->end_time}}</td>
                            <td>{{$u->time_allow}} Minute</td>
                            <td>{{$u->shift_desc}}</td>
                            <td>
                                <a href="{{route('shift.edit',$u->id)}}" ><i class="fa fa-edit"></i></a>
