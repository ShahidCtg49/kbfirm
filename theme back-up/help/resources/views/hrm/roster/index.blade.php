	...
	<div class="col-6">
        ...
        <div class="widget-box">
			<div class="widget-header widget-header-small">
				<h5 class="widget-title lighter">Grade Add Form</h5>
			</div>
			<div class="widget-body">
				<div class="widget-main">
					<form action="{{route('roster.store')}}" method="post" class="form-search" enctype="multipart/form-data">
					@csrf
						<div class="row">
						<div class="col-12 col-sm-6">
								<div class="form-group @if($errors->has('roster_name')) has-error @endif">
									<label>Roster Group</label>
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="roster_name" value="{{old('roster_name')}}">
										@if($errors->has('roster_name')) 
											<i class="ace-icon fa fa-times-circle"></i>
										@endif
									</span>
									@if($errors->has('roster_name')) 
										<div class="help-block col-sm-reset">
									{{ $errors->first('roster_name') }}
										</div>
								@endif
								</div>
							</div>
							<div class="col-12 col-sm-6">
								<div class="form-group @if($errors->has('roster_desc')) has-error @endif">
									<label>Roster Description</label>
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="roster_desc" value="{{old('roster_desc')}}">
										@if($errors->has('roster_desc')) 
											<i class="ace-icon fa fa-times-circle"></i>
										@endif
									</span>
									@if($errors->has('roster_desc')) 
										<div class="help-block col-sm-reset">
									{{ $errors->first('roster_desc') }}
										</div>
								@endif
								</div>
							</div>
                ...
                @if($roster)
                    @foreach($roster as $i=>$u)
                        <tr>
                            ...
                            <td>{{$u->roster_desc}}</td>
                            <td>
                                <a href="{{route('roster.edit',$u->id)}}" ><i class="fa fa-edit"></i></a>
