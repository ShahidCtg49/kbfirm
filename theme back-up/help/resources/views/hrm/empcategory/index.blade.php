...
<div class="row">
	<div class="col-6">
        ...
        <div class="widget-box">
			<div class="widget-header widget-header-small">
				<h5 class="widget-title lighter">Categoryd Add Form</h5>
			</div>
			<div class="widget-body">
				<div class="widget-main">
					<form action="{{route('empcategory.store')}}" method="post" class="form-search" enctype="multipart/form-data">
					@csrf
						<div class="row">
							<div class="col-12 col-sm-6">
								<div class="form-group @if($errors->has('empcategory')) has-error @endif">
									<label>Category Name</label>
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="empcategory" value="{{old('empcategory')}}">
										@if($errors->has('empcategory')) 
											<i class="ace-icon fa fa-times-circle"></i>
										@endif
									</span>
									@if($errors->has('empcategory')) 
										<div class="help-block col-sm-reset">
									{{ $errors->first('empcategory') }}
										</div>
								@endif
								</div>
							</div>
    ...
    <div class="col-6">
        ...
        <table class="table">
            ...
            <tbody>
                @if($empcategory)
                    @foreach($empcategory as $i=>$u)
                        <tr>
                            <td>{{++$i}}</td>
                            <td>{{$u->empcategory}}</td>
                            <td>
                                <a href="{{route('empcategory.edit',$u->id)}}" ><i class="fa fa-edit"></i></a>
