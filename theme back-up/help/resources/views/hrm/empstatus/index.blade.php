...
<div class="row">
	<div class="col-6">
        ...
        <div class="widget-box">
			<div class="widget-header widget-header-small">
				<h5 class="widget-title lighter">Employee Status Add Form</h5>
			</div>
			<div class="widget-body">
				<div class="widget-main">
					<form action="{{route('empstatus.store')}}" method="post" class="form-search" enctype="multipart/form-data">
					@csrf
						<div class="row">
						<div class="col-12 col-sm-6">
								<div class="form-group @if($errors->has('emp_status')) has-error @endif">
									...
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="emp_status" value="{{old('emp_status')}}">
    ...
    <div class="col-6">
        ...
        <table class="table">
            ...
            <tbody>
                @if($empstatus)
                    @foreach($empstatus as $i=>$u)
                        <tr>
                            <td>{{++$i}}</td>
                            <td>{{$u->emp_status}}</td>
                            <td>
                                <a href="{{route('empstatus.edit',$u->id)}}" ><i class="fa fa-edit"></i></a>
