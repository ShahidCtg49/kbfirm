...
<div class="row">
	<div class="col-6">
        ...
        <div class="widget-box">
			<div class="widget-header widget-header-small">
				<h5 class="widget-title lighter">Job Section Add Form</h5>
			</div>
			<div class="widget-body">
				<div class="widget-main">
					<form action="{{route('section.store')}}" method="post" class="form-search" enctype="multipart/form-data">
					@csrf
						<div class="row">
						<div class="col-12 col-sm-6">
								<div class="form-group @if($errors->has('section_name')) has-error @endif">
									...
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="section_name" value="{{old('section_name')}}">
							...
							<div class="col-12 col-sm-6">
								<div class="form-group @if($errors->has('section_desc')) has-error @endif">
									<label>Section Description</label>
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="section_desc" value="{{old('section_desc')}}">
										@if($errors->has('section_desc')) 
											<i class="ace-icon fa fa-times-circle"></i>
										@endif
									</span>
									@if($errors->has('section_desc')) 
										<div class="help-block col-sm-reset">
									{{ $errors->first('section_desc') }}
										</div>
								@endif
								</div>
							</div>
    ...
    <div class="col-6">
        ...
        <table class="table">
            ...
            <tbody>
                @if($section)
                    @foreach($section as $i=>$u)
                        <tr>
                            <td>{{++$i}}</td>
                            <td>{{$u->section_name}}</td>
                            <td>{{$u->section_desc}}</td>
                            <td>
                                <a href="{{route('section.edit',$u->id)}}" ><i class="fa fa-edit"></i></a>
