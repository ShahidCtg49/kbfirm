...
<div class="row">
	<div class="col-6">
        ...
        <div class="widget-box">
			<div class="widget-header widget-header-small">
				<h5 class="widget-title lighter">Job Location Add Form</h5>
			</div>
			<div class="widget-body">
				<div class="widget-main">
					<form action="{{route('location.store')}}" method="post" class="form-search" enctype="multipart/form-data">
					@csrf
						<div class="row">
						<div class="col-12 col-sm-6">
								<div class="form-group @if($errors->has('location_name')) has-error @endif">
									...
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="location_name" value="{{old('location_name')}}">
							...
							<div class="col-12 col-sm-6">
								<div class="form-group @if($errors->has('location_desc')) has-error @endif">
									<label>Location Description</label>
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="location_desc" value="{{old('location_desc')}}">
    ...
    <div class="col-6">
        ...
        <table class="table">
            ...
            <tbody>
                @if($location)
                    @foreach($location as $i=>$u)
                        <tr>
                            <td>{{++$i}}</td>
                            <td>{{$u->location_name}}</td>
                            <td>{{$u->location_desc}}</td>
                            <td>
                                <a href="{{route('location.edit',$u->id)}}" ><i class="fa fa-edit"></i></a>
