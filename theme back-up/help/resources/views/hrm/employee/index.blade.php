...
<div class="row">
    ...
    <a class="btn btn-primary pull-right" href="{{route('employeebasic.create')}}">Add New</a>
        <!-- PAGE CONTENT BEGINS -->
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                @if($employee)
                    @foreach($employee as $i=>$u)
						@php $status=array("","Active","Inactive","Temporarry"); @endphp
                        <tr>
                            <td>{{++$i}}</td>
							<td>{{$u->emp_name}}</td>
                            <td>{{$u->emp_father}}</td>
                            ...
                            <td>{{$u->emp_email}}</td>
                            <td>{{$u->emp_mobile}}</td>
							<td>{{$status[$u->emp_status]}}</td>
                            <td>
                                <a href="{{route('employeebasic.edit',$u->id)}}" title="Edit"><i class="fa fa-edit"></i></a>
								&nbsp;
                                <a href="{{route('employeebasic.show',$u->id)}}" title="Show"><i class="fa fa-eye"></i></a>
                            </td>
