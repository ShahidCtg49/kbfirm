					...
					<div id="fuelux-wizard-container">
						...
						<div class="step-content pos-rel">
							<div class="step-pane active" data-step="1">
								<form action="{{route('employeebasic.update',$emp->id)}}" enctype="multipart/form-data" method="post" class="form-search">
									@csrf @method('PUT')
									<div class="row">
										<div class="col-12 col-sm-3">
											<div class="form-group @if($errors->has('emp_name')) has-error @endif">
												...
												<span class="block input-icon input-icon-right">
													<input type="text" class="width-100" name="emp_name" value="{{old('emp_name',$emp->emp_name)}}">
										...
										<div class="col-12 col-sm-3">
											<div class="form-group @if($errors->has('emp_short_name')) has-error @endif">
												...
												<span class="block input-icon input-icon-right">
													<input type="text" class="width-100" name="emp_short_name" value="{{old('emp_short_name',$emp->emp_short_name)}}">
										...
										<div class="col-12 col-sm-3">
											<div class="form-group @if($errors->has('emp_father')) has-error @endif">
												...
												<span class="block input-icon input-icon-right">
													<input type="text" class="width-100" name="emp_father" value="{{old('emp_father',$emp->emp_father)}}">
										...
										<div class="col-12 col-sm-3">
											<div class="form-group @if($errors->has('emp_mother')) has-error @endif">
												...
												<span class="block input-icon input-icon-right">
													<input type="text" class="width-100" name="emp_mother" value="{{old('emp_mother',$emp->emp_mother)}}">
									...
									<div class="row">
										<div class="col-12 col-sm-6">
											<div class="form-group @if($errors->has('emp_present_address')) has-error @endif">
												...
												<span class="block input-icon input-icon-right">
												<textarea id="address1" class="form-control" name="emp_present_address" rows="6">{{old('emp_present_address',$emp->emp_present_address)}}</textarea>
										...
										<div class="col-12 col-sm-6">
											<div class="form-group @if($errors->has('emp_parmanent_address')) has-error @endif">
												...
												<span class="block input-icon input-icon-right">
													<textarea id="address" class="form-control" name="emp_parmanent_address" rows="6">{{old('emp_parmanent_address',$emp->emp_parmanent_address)}}</textarea>
									...
									<div class="row">
										<div class="col-12 col-sm-3">
											<div class="form-group @if($errors->has('emp_nid')) has-error @endif">
												...
												<span class="block input-icon input-icon-right">
												<input type="text" class="width-100" name="emp_nid" value="{{old('emp_nid',$emp->emp_nid)}}">
										...
										<div class="col-12 col-sm-3">
											<div class="form-group @if($errors->has('emp_email')) has-error @endif">
												...
												<span class="block input-icon input-icon-right">
												<input type="text" class="width-100" name="emp_email" value="{{old('emp_email',$emp->emp_email)}}">
										...
										<div class="col-12 col-sm-3">
											<div class="form-group @if($errors->has('emp_mobile')) has-error @endif">
												...
												<span class="block input-icon input-icon-right">
													<input type="text" class="width-100" name="emp_mobile" value="{{old('emp_mobile',$emp->emp_mobile)}}">
										...
										<div class="col-12 col-sm-3">
											<div class="form-group @if($errors->has('emp_alt_mobile')) has-error @endif">
												...
												<span class="block input-icon input-icon-right">
													<input type="text" class="width-100" name="emp_alt_mobile" value="{{old('emp_alt_mobile',$emp->emp_alt_mobile)}}">
											...
											<div class="form-group @if($errors->has('emp_gender')) has-error @endif">
												...
												<span class="block input-icon input-icon-right">
													<select class="width-100" name="emp_gender">
														...
														<option value="1" {{"1"==old('emp_gender',$emp->emp_gender)?'selected':''}}>Male</option>
														<option value="2" {{"2"==old('emp_gender',$emp->emp_gender)?'selected':''}}>Female</option>
														<option value="3" {{"3"==old('emp_gender',$emp->emp_gender)?'selected':''}}>Others</option>
													</select>
											...
											<div class="form-group @if($errors->has('emp_blood')) has-error @endif">
												...
												<span class="block input-icon input-icon-right">
													<select class="width-100" name="emp_blood">
														...
														<option value="1" {{"1"==old('emp_blood',$emp->emp_blood)?'selected':''}}>A+</option>
														<option value="2" {{"2"==old('emp_blood',$emp->emp_blood)?'selected':''}}>A-</option>
														<option value="3" {{"3"==old('emp_blood',$emp->emp_blood)?'selected':''}}>B+</option>
														<option value="4" {{"4"==old('emp_blood',$emp->emp_blood)?'selected':''}}>B-</option>
														<option value="5" {{"5"==old('emp_blood',$emp->emp_blood)?'selected':''}}>O+</option>
														<option value="6" {{"6"==old('emp_blood',$emp->emp_blood)?'selected':''}}>O-</option>
														<option value="7" {{"7"==old('emp_blood',$emp->emp_blood)?'selected':''}}>AB-</option>
														<option value="8" {{"8"==old('emp_blood',$emp->emp_blood)?'selected':''}}>AB+</option>
													</select>
											...
											<div class="form-group @if($errors->has('emp_maritals_tatus')) has-error @endif">
												...
												<span class="block input-icon input-icon-right">
													<select class="width-100" name="emp_maritals_tatus">
														...
														<option value="1" {{'1'==old('emp_maritals_tatus',$emp->emp_maritals_tatus)?'selected':''}}>Marrid</option>
														<option value="2" {{'2'==old('emp_maritals_tatus',$emp->emp_maritals_tatus)?'selected':''}}>Unmarrid</option>
													</select>
											...
											<div class="form-group @if($errors->has('emp_religion')) has-error @endif">
												...
												<span class="block input-icon input-icon-right">
													<select class="width-100" name="emp_religion">
														...
														<option value="1" {{'1'==old('emp_religion',$emp->emp_religion)?'selected':''}}>Islam</option>
														<option value="2" {{'2'==old('emp_religion',$emp->emp_religion)?'selected':''}}>Hinduism</option>
														<option value="3" {{'3'==old('emp_religion',$emp->emp_religion)?'selected':''}}>Christianity</option>
														<option value="4" {{'4'==old('emp_religion',$emp->emp_religion)?'selected':''}}>Buddhism</option>
									...
									<div class="row">
										<div class="col-12 col-sm-3">
											<div class="form-group @if($errors->has('emp_spouse')) has-error @endif">
												...
												<span class="block input-icon input-icon-right">
												<input type="text" class="width-100" name="emp_spouse" value="{{old('emp_spouse',$emp->emp_spouse)}}">
										...
										<div class="col-12 col-sm-3">
											<div class="form-group @if($errors->has('emp_nationality')) has-error @endif">
												...
												<span class="block input-icon input-icon-right">
												<input type="text" class="width-100" name="emp_nationality" value="{{old('emp_nationality',$emp->emp_nationality)}}">
										...
										<div class="col-12 col-sm-3">
											<div class="form-group @if($errors->has('emp_dob')) has-error @endif">
												...
												<span class="block input-icon input-icon-right">
													<input type="date" class="width-100" name="emp_dob" value="{{old('emp_dob',$emp->emp_dob)}}">
										...
										<div class="col-12 col-sm-3">
											<div class="form-group @if($errors->has('emp_passport_no')) has-error @endif">
												...
												<span class="block input-icon input-icon-right">
													<input type="text" class="width-100" name="emp_passport_no" value="{{old('emp_passport_no',$emp->emp_passport_no)}}">
									...
									<div class="row">
										<div class="col-12 col-sm-3">
											<div class="form-group @if($errors->has('emp_passport_issue_date')) has-error @endif">
												...
												<span class="block input-icon input-icon-right">
												<input type="date" class="width-100" name="emp_passport_issue_date" value="{{old('emp_passport_issue_date',$emp->emp_passport_issue_date)}}">
										...
										<div class="col-12 col-sm-3">
											<div class="form-group @if($errors->has('emp_passport_exp_date')) has-error @endif">
												...
												<span class="block input-icon input-icon-right">
												<input type="date" class="width-100" name="emp_passport_exp_date" value="{{old('emp_passport_exp_date',$emp->emp_passport_exp_date)}}">
										...
										<div class="col-12 col-sm-3">
											<div class="form-group @if($errors->has('emp_nomini_name')) has-error @endif">
												...
												<span class="block input-icon input-icon-right">
													<input type="text" class="width-100" name="emp_nomini_name" value="{{old('emp_nomini_name',$emp->emp_nomini_name)}}">
										...
										<div class="col-12 col-sm-3">
											<div class="form-group @if($errors->has('emp_nomini_relation')) has-error @endif">
												...
												<span class="block input-icon input-icon-right">
													<input type="text" class="width-100" name="emp_nomini_relation" value="{{old('emp_nomini_relation',$emp->emp_nomini_relation)}}">
									...
									<div class="row">
										<div class="col-12 col-sm-3">
											<div class="form-group @if($errors->has('emp_nomini_contact_no')) has-error @endif">
												...
												<span class="block input-icon input-icon-right">
												<input type="text" class="width-100" name="emp_nomini_contact_no" value="{{old('emp_nomini_contact_no',$emp->emp_nomini_contact_no)}}">
											...
											<div class="form-group @if($errors->has('emp_status')) has-error @endif">
												...
												<span class="block input-icon input-icon-right">
													<select class="width-100" name="emp_status">
														<option value=''>Select Status</option>
														<option value='1' {{'1'==old('emp_status',$emp->emp_status)?'selected':''}}>Active</option>
														<option value='2' {{'2'==old('emp_status',$emp->emp_status)?'selected':''}}>Inactive</option>
														<option value='3' {{'3'==old('emp_status',$emp->emp_status)?'selected':''}}>Temporarry</option>
													</select>
										...
										<div class="col-12 col-sm-3">
											<div class="form-group @if($errors->has('total_salary')) has-error @endif">
												...
												<span class="block input-icon input-icon-right">
													<input type="text" class="width-100" name="total_salary" value="{{old('total_salary',$emp->total_salary)}}">
