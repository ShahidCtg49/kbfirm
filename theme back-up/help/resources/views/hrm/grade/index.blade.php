...
<div class="row">
        ...
        <div class="widget-box">
			...
			<div class="widget-body">
				<div class="widget-main">
					<form action="{{route('grade.store')}}" method="post" class="form-search" enctype="multipart/form-data">
					@csrf
						<div class="row">
						<div class="col-12 col-sm-6">
								<div class="form-group @if($errors->has('grade_code')) has-error @endif">
									<label>Grade Code</label>
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="grade_code" value="{{old('grade_code')}}">
									...
									{{ $errors->first('grade_code') }}
										</div>
								@endif
								</div>
							</div>
							<div class="col-12 col-sm-6">
								<div class="form-group @if($errors->has('grade_desc')) has-error @endif">
									<label>Grade Name</label>
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="grade_desc" value="{{old('grade_desc')}}">
										@if($errors->has('grade_desc')) 
											<i class="ace-icon fa fa-times-circle"></i>
										@endif
									</span>
									@if($errors->has('grade_desc')) 
										<div class="help-block col-sm-reset">
									{{ $errors->first('grade_desc') }}
										</div>
								@endif
								</div>
							</div>
    ...
    <div class="col-6">
        ...
        <table class="table">
            ...
            <tbody>
                @if($grade)
                    @foreach($grade as $i=>$u)
                        <tr>
                            <td>{{++$i}}</td>
                            <td>{{$u->grade_code}}</td>
                            <td>{{$u->grade_desc}}</td>
                            <td>
                                <a href="{{route('grade.edit',$u->id)}}" ><i class="fa fa-edit"></i></a>
