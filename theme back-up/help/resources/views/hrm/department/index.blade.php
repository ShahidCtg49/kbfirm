...
<div class="row">
	<div class="col-6">
        ...
        <div class="widget-box">
			<div class="widget-header widget-header-small">
				<h5 class="widget-title lighter">Department Add Form</h5>
			</div>
			<div class="widget-body">
				<div class="widget-main">
					<form action="{{route('department.store')}}" method="post" class="form-search" enctype="multipart/form-data">
					@csrf
						<div class="row">
							<div class="col-12 col-sm-6">
								<div class="form-group @if($errors->has('department')) has-error @endif">
									...
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="department" value="{{old('department')}}">
    ...
    <div class="col-6">
        ...
        <table class="table">
            ...
            <tbody>
                @if($department)
                    @foreach($department as $i=>$u)
                        <tr>
                            <td>{{++$i}}</td>
                            <td>{{$u->department}}</td>
                            <td>
                                <a href="{{route('department.edit',$u->id)}}" ><i class="fa fa-edit"></i></a>
