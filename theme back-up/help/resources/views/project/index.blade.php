...
<div class="row">
    ...
    <a class="btn btn-primary pull-right" href="{{route('project.create')}}">Add New</a>
        <!-- PAGE CONTENT BEGINS -->
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                @if($project)
                    @foreach($project as $i=>$u)
                        <tr>
                            <td>{{++$i}}</td>
							<td>{{$u->project}}</td>
                            <td>{{$u->company_name->company_name}}</td>
                            <td>{{$u->contact_no}}</td>
                            <td>{{$u->email}}</td>
                            <td>
                                <a href="{{route('project.edit',$u->id)}}" ><i class="fa fa-edit"></i></a>
