...
class UserController extends Controller
{
    ...
    public function create()
    {
        ...
        $company=Company::all();
        $branch=Branch::all();
        return view('users.create',compact('role','company','branch'));
    }
    ...
    public function store(CreateRequest $r)
    {
        try{
            ...
            $user->company_id=$r->company_id;
            $user->branch_id=$r->branch_id;
            if(!!$user->save()){
    ...
    public function edit($id)
    {
        ...
        $company=Company::all();
        $branch=Branch::all();
        return view('users.edit',compact('user','role','company','branch'));
    }
