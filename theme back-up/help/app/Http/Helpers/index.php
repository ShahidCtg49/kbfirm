...
function  status(){
    return [
        'Pending','Active','Inactive','Freez','Block'
    ];
}

function  ServiceType(){
    return [
        'Website and Software Development','Digital Marketing','Hardware Departmnet','Domain and Server','Data Entry','Graphics Design And Video Editing'
    ];
}